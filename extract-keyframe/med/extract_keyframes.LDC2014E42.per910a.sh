...
./runme_extract_keyframes.sh LDC2014E42 0 100000 

#./runme_extract_keyframes.sh LDC2014E42 0 25000 & 
#./runme_extract_keyframes.sh LDC2014E42 25000 50000 & 
#./runme_extract_keyframes.sh LDC2014E42 50000 75000 & 
#./runme_extract_keyframes.sh LDC2014E42 75000 100000 & 
#wait
date
