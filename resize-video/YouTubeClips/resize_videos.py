...
def resize(in_video_path, out_video_path, tmp_path, start_vid = None, end_vid = float('inf'), file_ext = None):	
...
ldc_dir = '/net/per610a/export/das11f/plsang/dataset'
tmp_dir = '/net/per610a/export/das11f/plsang/dataset/tmp'
...
out_video_path = ldc_dir + '/' + ldc_pat + '-Resized';
