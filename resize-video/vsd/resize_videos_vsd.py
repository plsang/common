...
video_path = '/net/per610a/export/das11f/ledduy/mediaeval-vsd-2013/video-rsz/';
...
for idx in range(start_vid, end_vid):
	...
	command = 'ffmpeg -i ' + old_file + ' -strict -2 -y -s 320x' + str(new_h) + ' -aspect ' + str(w) + ':' + str(h) + ' ' + new_file
	print command
